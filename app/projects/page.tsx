...
export default function Projects() {
  return (<Page pageTitle="Selected work." eyebrow="01 / Project index" count={order.length} serial="SKV-WORK-2026" intro="From data infrastructure to connected hardware. A collection of systems designed, built, and put to work.">
