            ...
            <div className="max-md:flex max-md:flex-col md:grid md:grid-cols-2">
                ...
                <div className="m-2 md:col-start-2 md:col-span-1 md:flex md:my-auto md:mx-8">
                    <div className="text-md md:text-[1.5vw]">
                        The <b>LED Matrix panel</b> is connected to the <b>ESP32</b> via the I2C interface. The ESP32 obtains information via pre-rendered WEBP animations generated by the <b>remote API endpoints</b> to then display on the LED panel.
                    </div>
                </div>
                <div className="md:col-start-1 md:col-span-1 md:m-8">
                    <Image 
