        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className="space-y-4 sm:space-y-6 text-center lg:text-left relative">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold text-white leading-tight relative z-10 whitespace-nowrap">
                Hi, I&apos;m Sanjay
              </h1>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-neutral-800/70 backdrop-blur-sm rounded-lg p-6 shadow-lg">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="flex flex-col items-center space-y-2">
                    ...
                    <span className="text-gray-300 text-sm">C/C++</span>
                  </div>
                  <div className="flex flex-col items-center space-y-2">
              ...
              {/* Data Analysis & ML */}
              <div className="bg-neutral-800/70 backdrop-blur-sm rounded-lg p-6 shadow-lg">
                <h3 className="text-xl font-bold text-white mb-6 text-center">Data Analysis & ML</h3>
                <div className="grid grid-cols-2 gap-4">
                  <div className="flex flex-col items-center space-y-2">
                    <div className="w-12 h-12 bg-orange-600/20 rounded-lg flex items-center justify-center">
                      <span className="text-orange-400 font-bold text-lg">NP</span>
                    </div>
                    <span className="text-gray-300 text-sm">NumPy</span>
                  </div>
                  <div className="flex flex-col items-center space-y-2">
                    <div className="w-12 h-12 bg-blue-400/20 rounded-lg flex items-center justify-center">
                      <span className="text-blue-400 font-bold text-lg">PD</span>
                    </div>
                    <span className="text-gray-300 text-sm">Pandas</span>
                  </div>
                  <div className="flex flex-col items-center space-y-2">
                    <div className="w-12 h-12 bg-green-500/20 rounded-lg flex items-center justify-center">
                      <span className="text-green-400 font-bold text-lg">RF</span>
                    </div>
                    <span className="text-gray-300 text-sm">RandomForest</span>
                  </div>
                  <div className="flex flex-col items-center space-y-2">
                    ...
                    <span className="text-gray-300 text-sm">XGBoost</span>
                  </div>
                  <div className="flex flex-col items-center space-y-2">
                    <div className="w-12 h-12 bg-purple-500/20 rounded-lg flex items-center justify-center">
                      <span className="text-purple-400 font-bold text-lg">CP</span>
                    </div>
                    <span className="text-gray-300 text-sm">CellProfiler</span>
                  </div>
                  <div className="flex flex-col items-center space-y-2">
                    <div className="w-12 h-12 bg-red-600/20 rounded-lg flex items-center justify-center">
                      <span className="text-red-400 font-bold text-lg">GG</span>
                    </div>
                    <span className="text-gray-300 text-sm">ggplot2</span>
                  </div>
                </div>
              </div>
              ...
              {/* Web & Development */}
              <div className="bg-neutral-800/70 backdrop-blur-sm rounded-lg p-6 shadow-lg">
                <h3 className="text-xl font-bold text-white mb-6 text-center">Web & Development</h3>
                <div className="grid grid-cols-2 gap-4">
                  <div className="flex flex-col items-center space-y-2">
